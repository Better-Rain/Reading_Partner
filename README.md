...
The app also includes the first local vocabulary workflow: selected PDF text can be saved to the active document's vocabulary book, and vocabulary items are persisted in SQLite with source page metadata.
